...
const SeeOrdersWaiter = ({orderWithId}) => {
      ...
      return (
        <div className="container">
          <div className="textOrderChef">
            <h1 className="textOrderOrders textOrderOrdersCHEF">PEDIDOS LISTOS PARA ENTREGAR</h1>
          </div>
          <div className="containerAlltextOrderItemsChef">
            {table1.map((orderT1, index) => {
              // console.log("status", orderT1.status);
              return orderT1.status === "Ready" ? (
...
export default withRouter(SeeOrdersWaiter)